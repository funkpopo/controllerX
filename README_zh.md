...
- DualShock 4 的输入匹配已经实现，但当前内置素材中没有 DualShock 4 的显示预设。使用 DS4 时，应用会提示缺少可视化预设。详情见 `docs/ds4-asset-status.md`。
- 部分校准和热插拔验证需要真实手柄测试。详情见 `docs/verification.md`。
- 本地构建的 Windows 安装包默认未签名。如需签名，需要准备代码签名证书。详情见 `docs/release.md`。
